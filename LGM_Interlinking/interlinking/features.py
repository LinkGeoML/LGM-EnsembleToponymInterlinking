...
from LGM_Interlinking.interlinking.helpers import transform, StaticValues
from LGM_Interlinking.interlinking import sim_measures # import LGMSimVars, lgm_sim_split, score_per_term, weighted_sim, sim_measures
...
class Features:
    ...
    * *lgm*: similarity features based on variations of LGM-Sim similarity measures.
    ...
    def load_data(self, fname, encoding):
        self.data_df = pd.read_csv(fname)
